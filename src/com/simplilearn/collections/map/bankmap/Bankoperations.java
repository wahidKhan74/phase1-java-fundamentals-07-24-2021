...
public class Bankoperations {
	...
	public void showas(Map<Long, Account> accountMap){
		
	}
	
	public void withdrawAmount(Map<Long, Account> accountMap, double withdrawAmt) {
		
		Account x = accountMap.get(10101L);
		System.out.println(x.getBalance());
		double acctBalance = x.getBalance();
